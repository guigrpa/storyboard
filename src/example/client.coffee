...
{mainStory, chalk, addPlugin} = require '../storyboard'  # you'd write: `'storyboard'`
addPlugin require('../listeners/console').default
addPlugin require('../listeners/browserExtension').default
addPlugin require('../listeners/wsClient')
